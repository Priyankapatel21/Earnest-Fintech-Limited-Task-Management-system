      ...
      <div className="w-full max-w-[850px] h-[550px] bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex transition-all border border-gray-50">
        <div className="flex-1 flex flex-col p-10 md:p-12 justify-center">
          <div className="mb-6">
            ...
            <h2 className="text-3xl font-black text-gray-900 mb-1 leading-tight">Welcome Back!</h2>
            <p className="text-gray-400 font-bold text-xs tracking-widest">Please enter login details below</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-100 rounded-xl px-4 py-3 text-sm font-bold text-black outline-none focus:border-gray-900 transition-all placeholder:text-gray-300" 
              />
            </div>
            <div>
              ...
              <div className="text-right mt-1.5">
                <Link href="/forgot-password" title="reset" className="text-xs font-black text-gray-800 hover:text-[#5C59C2] transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>

            <button className="w-full bg-[#5C59C2] hover:bg-[#4B48A3] text-white py-3.5 rounded-xl font-black text-md shadow-lg shadow-[#5C59C2]/20 transition-all active:scale-[0.98]">
              Sign in
            </button>
          </form>
          ...
          <div className="text-center mt-6 space-y-4">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 py-3 rounded-xl font-black border border-gray-100 transition-all shadow-sm active:scale-[0.98]"
            >
            ...
            <p className="text-xs font-black text-gray-400">
              ...
              <Link href="/register" className="text-[#5C59C2] hover:underline ml-1">Register</Link>
            </p>
          </div>
        </div>
